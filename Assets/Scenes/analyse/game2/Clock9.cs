...
public class Clock9 : MonoBehaviour
{
    ...
    public void isWrong()
{
    ...
    public async void ShowTextOnce(Text textToDisplay)
{
    textToDisplay.gameObject.SetActive(true); // 显示提示文本

    await Task.Delay(500); // 延迟0.5秒

    textToDisplay.gameObject.SetActive(false); // 隐藏提示文本
}
}
