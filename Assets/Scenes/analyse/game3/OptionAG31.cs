...
public class OptionAG31 : MonoBehaviour
{

    public TimeAG31 timeAG11;

    private bool isChoose = false;
    private OptionAG31 AOption; // 00选项的脚本引用
    private OptionAG31 BOption; // 01选项的脚本引用
    private OptionAG31 COption; // 10选项的脚本引用
    private OptionAG31 DOption; // 11选项的脚本引用
