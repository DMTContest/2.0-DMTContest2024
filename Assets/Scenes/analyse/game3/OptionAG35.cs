...
public class OptionAG35 : MonoBehaviour
{

    public TimeAG35 timeAG11;

    private bool isChoose = false;
    private OptionAG35 AOption; // 00选项的脚本引用
    private OptionAG35 BOption; // 01选项的脚本引用
    private OptionAG35 COption; // 10选项的脚本引用
    private OptionAG35 DOption; // 11选项的脚本引用
