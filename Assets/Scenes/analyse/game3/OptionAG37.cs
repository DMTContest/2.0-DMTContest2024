...
public class OptionAG37 : MonoBehaviour
{

    public TimeAG37 timeAG11;

    private bool isChoose = false;
    private OptionAG37 AOption; // 00选项的脚本引用
    private OptionAG37 BOption; // 01选项的脚本引用
    private OptionAG37 COption; // 10选项的脚本引用
    private OptionAG37 DOption; // 11选项的脚本引用
