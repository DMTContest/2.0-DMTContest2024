...
public class OptionAG38 : MonoBehaviour
{

    public TimeAG38 timeAG11;

    private bool isChoose = false;
    private OptionAG38 AOption; // 00选项的脚本引用
    private OptionAG38 BOption; // 01选项的脚本引用
    private OptionAG38 COption; // 10选项的脚本引用
    private OptionAG38 DOption; // 11选项的脚本引用
