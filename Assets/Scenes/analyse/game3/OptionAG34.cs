...
public class OptionAG34 : MonoBehaviour
{

    public TimeAG34 timeAG11;

    private bool isChoose = false;
    private OptionAG34 AOption; // 00选项的脚本引用
    private OptionAG34 BOption; // 01选项的脚本引用
    private OptionAG34 COption; // 10选项的脚本引用
    private OptionAG34 DOption; // 11选项的脚本引用
