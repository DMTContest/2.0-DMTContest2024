...
public class OptionAG39 : MonoBehaviour
{

    public TimeAG39 timeAG11;

    private bool isChoose = false;
    private OptionAG39 AOption; // 00选项的脚本引用
    private OptionAG39 BOption; // 01选项的脚本引用
    private OptionAG39 COption; // 10选项的脚本引用
    private OptionAG39 DOption; // 11选项的脚本引用
    ...
    private void Start()
    {
        ...
        AOption = OA.GetComponent<OptionAG39>();

        GameObject OB = GameObject.Find("Btn_2");

        BbuttonImage = OB.GetComponent<Image>();
        BOption = OB.GetComponent<OptionAG39>();

        GameObject OC = GameObject.Find("Btn_3");
        COption = OC.GetComponent<OptionAG39>();

        GameObject OD = GameObject.Find("Btn_1");
        DOption = OD.GetComponent<OptionAG39>();
