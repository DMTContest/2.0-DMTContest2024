...
public class OptionAG32 : MonoBehaviour
{

    public TimeAG32 timeAG11;

    private bool isChoose = false;
    private OptionAG32 AOption; // 00选项的脚本引用
    private OptionAG32 BOption; // 01选项的脚本引用
    private OptionAG32 COption; // 10选项的脚本引用
    private OptionAG32 DOption; // 11选项的脚本引用
    ...
    private void Start()
    {
        ...
        AOption = OA.GetComponent<OptionAG32>();

        GameObject OB = GameObject.Find("Btn_2");

        BbuttonImage = OB.GetComponent<Image>();
        BOption = OB.GetComponent<OptionAG32>();

        GameObject OC = GameObject.Find("Btn_1");
        COption = OC.GetComponent<OptionAG32>();

        GameObject OD = GameObject.Find("Btn_4");
        DOption = OD.GetComponent<OptionAG32>();
