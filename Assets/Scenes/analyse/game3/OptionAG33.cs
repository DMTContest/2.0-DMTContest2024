...
public class OptionAG33 : MonoBehaviour
{

    public TimeAG33 timeAG11;

    private bool isChoose = false;
    private OptionAG33 AOption; // 00选项的脚本引用
    private OptionAG33 BOption; // 01选项的脚本引用
    private OptionAG33 COption; // 10选项的脚本引用
    private OptionAG33 DOption; // 11选项的脚本引用
