...
public class OptionAG13 : MonoBehaviour
{

    public TimeAG13 timeAG13;

    private bool isChoose = false;
    private OptionAG13 AOption; // 00选项的脚本引用
    private OptionAG13 BOption; // 01选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            BOption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG14");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG13.ReduceTime(10f);
