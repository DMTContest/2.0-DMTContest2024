...
public class OptionAG11 : MonoBehaviour
{

    public TimeAG11 timeAG11;

    private bool isChoose = false;
    private OptionAG11 AOption; // 00选项的脚本引用
    private OptionAG11 BOption; // 01选项的脚本引用
