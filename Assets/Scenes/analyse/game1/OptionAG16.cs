...
public class OptionAG16 : MonoBehaviour
{

    public TimeAG16 timeAG16;

    private bool isChoose = false;
    private OptionAG16 AOption; // 00选项的脚本引用
    private OptionAG16 BOption; // 01选项的脚本引用
    private OptionAG16 COption; // 10选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG17");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG16.ReduceTime(10f);
