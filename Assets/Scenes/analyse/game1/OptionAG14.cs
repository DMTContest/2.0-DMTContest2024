...
public class OptionAG14 : MonoBehaviour
{

    public TimeAG14 timeAG14;

    private bool isChoose = false;
    private OptionAG14 AOption; // 00选项的脚本引用
    private OptionAG14 BOption; // 01选项的脚本引用
    private OptionAG14 COption; // 10选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG15");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG14.ReduceTime(10f);
