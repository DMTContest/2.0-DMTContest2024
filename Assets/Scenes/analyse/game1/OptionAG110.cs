...
public class OptionAG110 : MonoBehaviour
{

    public TimeAG110 timeAG110;

    private bool isChoose = false;
    private OptionAG110 AOption; // 00选项的脚本引用
    private OptionAG110 BOption; // 01选项的脚本引用
    private OptionAG110 COption; // 10选项的脚本引用
    ...
    private void Start()
    {
        ...
        AOption = OA.GetComponent<OptionAG110>();

        GameObject OB = GameObject.Find("Btn_1");

        BbuttonImage = OB.GetComponent<Image>();
        BOption = OB.GetComponent<OptionAG110>();

        GameObject OC = GameObject.Find("Btn_3");
        COption = OC.GetComponent<OptionAG110>();
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG1Final");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG110.ReduceTime(10f);
