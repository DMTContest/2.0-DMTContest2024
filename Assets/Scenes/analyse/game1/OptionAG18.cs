...
public class OptionAG18 : MonoBehaviour
{

    public TimeAG18 timeAG18;

    private bool isChoose = false;
    private OptionAG18 AOption; // 00选项的脚本引用
    private OptionAG18 BOption; // 01选项的脚本引用
    private OptionAG18 COption; // 10选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG19");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG18.ReduceTime(10f);
