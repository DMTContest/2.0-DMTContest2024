...
public class OptionAG15 : MonoBehaviour
{

    public TimeAG15 timeAG15;

    private bool isChoose = false;
    private OptionAG15 AOption; // 00选项的脚本引用
    private OptionAG15 BOption; // 01选项的脚本引用
    private OptionAG15 COption; // 10选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG16");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG15.ReduceTime(10f);
