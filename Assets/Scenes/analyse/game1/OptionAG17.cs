...
public class OptionAG17 : MonoBehaviour
{

    public TimeAG17 timeAG17;

    private bool isChoose = false;
    private OptionAG17 AOption; // 00选项的脚本引用
    private OptionAG17 BOption; // 01选项的脚本引用
    private OptionAG17 COption; // 10选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG18");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG17.ReduceTime(10f);
