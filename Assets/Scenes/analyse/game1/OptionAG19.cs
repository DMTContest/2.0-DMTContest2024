...
public class OptionAG19 : MonoBehaviour
{

    public TimeAG19 timeAG19;

    private bool isChoose = false;
    private OptionAG19 AOption; // 00选项的脚本引用
    private OptionAG19 BOption; // 01选项的脚本引用
    private OptionAG19 COption; // 10选项的脚本引用
    ...
    private void CheckAnswer()
    {
            ...
            COption.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("AG110");
        }
        else 
        {
            Debug.Log("答错啦!");
            
            timeAG19.ReduceTime(10f);
