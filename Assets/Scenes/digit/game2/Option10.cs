...
public class Option10 : MonoBehaviour
{
    private bool isChoose = false;
    private Option10 AOption; // 00选项的脚本引用
    private Option10 BOption; // 01选项的脚本引用
    private Option10 COption; // 10选项的脚本引用
    private Option10 DOption; // 11选项的脚本引用
    ...
    private void Start()
    {
        ...
        AOption = OA.GetComponent<Option10>();

        GameObject OB = GameObject.Find("Btn_2");
        BOption = OB.GetComponent<Option10>();

        GameObject OC = GameObject.Find("Btn_3");
        COption = OC.GetComponent<Option10>();

        GameObject OD = GameObject.Find("Btn_4");
        DOption = OD.GetComponent<Option10>();
    ...
    {
        //Debug.Log("正在调用答案检查器");
        Option10 CorrectOption1 = COption;
        Option10 CorrectOption2 = DOption;
        Option10 CorrectOption3 = BOption;

        Option10 WrongOption1 = AOption;
            ...
            WrongOption1.isChoose == false)
        {
            Debug.Log("答对啦!");
            AOption.correct = 1;
            SceneManager.LoadScene("DG2Final");
        }
    }
}