...
public class Option8 : MonoBehaviour
{
    private bool isChoose = false;
    private Option8 AOption; // 00选项的脚本引用
    private Option8 BOption; // 01选项的脚本引用
    private Option8 COption; // 10选项的脚本引用
    private Option8 DOption; // 11选项的脚本引用
    ...
    private void Start()
    {
        ...
        AOption = OA.GetComponent<Option8>();

        GameObject OB = GameObject.Find("Btn_2");
        BOption = OB.GetComponent<Option8>();

        GameObject OC = GameObject.Find("Btn_3");
        COption = OC.GetComponent<Option8>();

        GameObject OD = GameObject.Find("Btn_4");
        DOption = OD.GetComponent<Option8>();
    ...
    {
        //Debug.Log("正在调用答案检查器");
        Option8 CorrectOption1 = AOption;
        Option8 CorrectOption2 = DOption;

        Option8 WrongOption1 = COption;
        Option8 WrongOption2 = BOption;
