...
public class Square9 : MonoBehaviour
{
    ...
    private Square9 CorrectAnswer;
    //错误答案
    private Square9 WrongAnswer1;
    private Square9 WrongAnswer2;
    private Square9 WrongAnswer3;
    private Square9 WrongAnswer4;

    public float correct = 0;
    public float wrong = 0;
    public float count = 0;

    public TimeDG39 time;

    // Start is called before the first frame update
    void Start()
    {
        GameObject Square = GameObject.Find("Square");
        CorrectAnswer = Square.GetComponent<Square9>();

        GameObject Square1 = GameObject.Find("Square (1)");
        WrongAnswer1 = Square1.GetComponent<Square9>();

        GameObject Square2 = GameObject.Find("Square (2)");
        WrongAnswer2 = Square2.GetComponent<Square9>();

        GameObject Square3 = GameObject.Find("Square (3)");
        WrongAnswer3 = Square3.GetComponent<Square9>();

        GameObject Square4 = GameObject.Find("Square (4)");
        WrongAnswer4 = Square4.GetComponent<Square9>();
    }
