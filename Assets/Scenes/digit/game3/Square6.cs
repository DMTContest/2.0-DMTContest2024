...
public class Square6 : MonoBehaviour
{

    public bool ischoose = false;
    private Square6 CorrectAnswer;
    //错误答案
    private Square6 WrongAnswer1;
    private Square6 WrongAnswer2;
    private Square6 WrongAnswer3;
    private Square6 WrongAnswer4;
    ...
    public TimeDG36 time;

    // Start is called before the first frame update
    void Start()
    {
        GameObject Square = GameObject.Find("Square");
        CorrectAnswer = Square.GetComponent<Square6>();

        GameObject Square1 = GameObject.Find("Square (1)");
        WrongAnswer1 = Square1.GetComponent<Square6>();

        GameObject Square2 = GameObject.Find("Square (2)");
        WrongAnswer2 = Square2.GetComponent<Square6>();

        GameObject Square3 = GameObject.Find("Square (3)");
        WrongAnswer3 = Square3.GetComponent<Square6>();

        GameObject Square4 = GameObject.Find("Square (4)");
        WrongAnswer4 = Square4.GetComponent<Square6>();
    }
