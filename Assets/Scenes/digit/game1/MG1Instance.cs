...
public class MG1Instance : MonoBehaviour
{
    ...
    private void Update()
    {
        if(SceneManager.GetActiveScene().name == "MG11"){
        ...
        if(SceneManager.GetActiveScene().name == "MG12")
        {
        ...
        }if(SceneManager.GetActiveScene().name == "MG13")
        {
        ...
        if(SceneManager.GetActiveScene().name == "MG14"){
        ...
        if(SceneManager.GetActiveScene().name == "MG15")
        {
        ...
        }if(SceneManager.GetActiveScene().name == "MG16")
        {
        ...
        if(SceneManager.GetActiveScene().name == "MG17"){
        ...
        if(SceneManager.GetActiveScene().name == "MG18")
        {
        ...
        }if(SceneManager.GetActiveScene().name == "MG19")
        {
        ...
        if(SceneManager.GetActiveScene().name == "MG20"){
        ...
        if (SceneManager.GetActiveScene().name == "MGFinal")
        {
           ScoreForDigitWind = 
        (
    ...
    private float GetTimeFromScene1()
    {
       ...
       TimeMG1 c = FindObjectOfType<TimeMG1>();
        if (c != null)
    {
        return c.timeStart;
    }
    ...
    {
       GameManager c = FindObjectOfType<GameManager>();
        if (c != null)
    {
        return c.wrong;
    }
    ...
    {
        // 查 Clock1 脚本并获取其 time 属性的值
       TimeMG2 c = FindObjectOfType<TimeMG2>();
        if (c != null)
    {
        return c.timeStart;
    }
    ...
    {
       GameManager2 c = FindObjectOfType<GameManager2>();
        if (c != null)
    {
        return c.wrong;
    }
