...
public class FangKuai8 : MonoBehaviour
{
    ...
    public TimeFG8 timeFG8; // 引用到 Countdown 脚本
    private bool isChoose = false;


    private FangKuai8 AOption; // 00选项的脚本引用
    private FangKuai8 BOption; // 01选项的脚本引用
    private FangKuai8 COption; // 10选项的脚本引用
    private FangKuai8 DOption; // 10选项的脚本引用
    ...
    void CheckAllButtonsClicked()
    {
        ...
        // 所有按钮都被点击了，进行页面跳转
        SceneManager.LoadScene("FangKuai9"); // 替换成你的目标场景名称
    }
