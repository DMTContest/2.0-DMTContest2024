...
public class FangKuai2 : MonoBehaviour
{
    ...
    public TimeFG2 timeFG2; // 引用到 Countdown 脚本

    private bool isChoose = false;

    private FangKuai2 AOption; // 00选项的脚本引用
    private FangKuai2 BOption; // 01选项的脚本引用
    private FangKuai2 COption; // 10选项的脚本引用
    ...
    void CheckAllButtonsClicked()
    {
        ...
        // 所有按钮都被点击了，进行页面跳转
        SceneManager.LoadScene("FangKuai3"); // 替换成你的目标场景名称
    }
