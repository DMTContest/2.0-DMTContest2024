...
public class FangKuai3 : MonoBehaviour
{
    ...
    public TimeFG3 timeFG3; // 引用到 Countdown 脚本

    private bool isChoose = false;

    private FangKuai3 AOption; // 00选项的脚本引用
    private FangKuai3 BOption; // 01选项的脚本引用
    ...
    void CheckAllButtonsClicked()
    {
        ...
        // 所有按钮都被点击了，进行页面跳转
        SceneManager.LoadScene("FangKuai4"); // 替换成你的目标场景名称
    }
